<template>
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100" height="100" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="spinner">
<g transform="scale(2)" transform-origin="center center">
<g transform="rotate(0 50 50)">
  <rect x="48" y="30" rx="2" ry="2.6" width="4" height="10" fill="#000000">
